...
onEvent('item.tags', event => {
	...
	//Tags for use in market recipes	
		...
		event.get('kubejs:market/export/farming')
			.add(KJ('#food_crate'))
			.add(FD('canvas'))
			.add(F('#berries'))
			.add(MC('cocoa_beans'))
		...
		event.get('kubejs:market/export/wood/1')
			.add(MC('oak_log'))
			.add(MC('spruce_log'))
			.add(MC('jungle_log'))
			.add(MC('dark_oak_log'))
			...
			.add(BOP('umbran_log'))
			.add(BOP('dead_log'))
		event.get('kubejs:market/export/wood/2')
			.add(MC('acacia_log'))
			.add(MC('birch_log'))
			.add(BOP('cherry_log'))
			.add(TC('skyroot_log'))
		...
		event.get('kubejs:market/export/wood/3')
			.add(BOP('willow_log'))
			.add(BOP('palm_log'))
		...
		event.get('kubejs:market/export/wood/4')
			.add(MC('crimson_stem'))
			.add(MC('warped_stem'))
			.add(TC('bloodshroom_log'))
		event.get('kubejs:market/export/carpentry')
			.add('#kubejs:market/export/wood/1')
			.add('#kubejs:market/export/wood/2')
			.add('#kubejs:market/export/wood/3')
			.add('#kubejs:market/export/wood/4')
			.add(BOP('hellbark_log'))
			.add('kubejs:profession_card_carpentry')

		event.get('kubejs:market/export/stone/1')
			...
			.add('create:scoria') 
		event.get('kubejs:market/export/crushed_raw_ores/8')
			.add(CR('crushed_raw_iron'))
			.add(CR('crushed_raw_copper'))
			.add(CR('crushed_raw_zinc'))
		event.get('kubejs:market/export/crushed_raw_ores/12')
			.add(CR('crushed_raw_nickel'))
			.add(CR('crushed_raw_lead'))
		event.get('kubejs:market/export/stone/6')
			.add(TE('cinnabar'))
			.add(TE('sulfur'))
			.add(TE('niter'))
			.add(MC('lapis_lazuli'))
		event.get('kubejs:market/export/gem/10')
			.add(TE('sapphire'))
			.add(TE('ruby'))
		event.get('kubejs:market/export/mining')
			.add('#kubejs:market/export/crushed_raw_ores/8')
			.add('#kubejs:market/export/crushed_raw_ores/12')
			.add('create:crushed_raw_gold')
			.add('#kubejs:market/export/stone/1')
			.add('#kubejs:market/export/stone/6')
			.add('#kubejs:market/export/gem/10')
			.add(MC('coal'))
			.add(TE('apatite'))
			.add(MC('diamond'))
			.add('kubejs:profession_card_mining')

		event.get('kubejs:market/export/brick/4')
			.add(SP('checker_block'))
			.add(AP('olivestone_bricks'))
			.add(AP('flint_tiles'))
		event.get('kubejs:market/export/brick/6')
			.add(AP('basalt_tiles'))
			.add(MC('bricks'))
			.add(TC('mud_bricks'))
			.add(AP('algal_bricks'))
		...
		event.get('kubejs:market/export/brick/8')
			.add(AP('packed_ice_pillar'))
			.add(AP('sunmetal_block'))
			.add(SP('daub_brace'))
		event.get('kubejs:market/export/brick/10')
			.add(AP('gilded_sandstone'))
			.add(TC('seared_bricks'))
			.add(CR('ornate_iron_window'))
		event.get('kubejs:market/export/masonry')
			.add('#kubejs:market/export/brick/4')
			.add('#kubejs:market/export/brick/6')
			.add('#kubejs:market/export/brick/8')
			.add('#kubejs:market/export/brick/10')
			.add(AP('abyssaline'))
			.add(MC('quartz_bricks'))
			.add('kubejs:profession_card_masonry')

		event.get('kubejs:market/export/drop/5')
			.add(RQ('rib_bone'))
			.add(RQ('zombie_heart'))
			.add(RQ('chelicerae'))
			.add(RQ('nebulous_heart'))
			.add(RQ('molten_core'))
		event.get('kubejs:market/export/drop/6')
			.add(RQ('slime_pearl'))
			.add(RQ('guardian_spike'))
		event.get('kubejs:market/export/drop/8')
			.add(MC('phantom_membrane'))
			.add(MC('rabbit_foot'))
		event.get('kubejs:market/export/drop/10')
			.add(RQ('bat_wing'))
			.add(MC('ghast_tear'))
			.add(RQ('catalyzing_gland'))
		event.get('kubejs:market/export/drop/15')
			.add(RQ('witch_hat'))
			.add(RQ('withered_rib'))
		event.get('kubejs:market/export/hunting')
			.add('#kubejs:market/export/drop/5')
			.add('#kubejs:market/export/drop/6')
			.add('#kubejs:market/export/drop/8')
			.add('#kubejs:market/export/drop/10')
			.add('#kubejs:market/export/drop/15')
		...
		event.get('kubejs:cake_slices')
			.add(FD('cake_slice'))
		event.get('kubejs:market/export/food/3')
			.add(AC('sushi'))
			...
			.add(FD('cod_roll'))
			.add(FD('salmon_roll'))
		event.get('kubejs:market/export/food/4')
			.add(CR('bar_of_chocolate'))
			.add(CR('honeyed_apple'))
			.add(CR('builders_tea'))
			.add(FD('chocolate_pie_slice'))
			.add(CR('sweet_roll'))
		event.get('kubejs:market/export/food/5')
			.add(FD('nether_salad'))
			...
			.add(FD('apple_cider'))
			.add(FD('melon_juice'))
		event.get('kubejs:market/export/food/6')
		...
		event.get('kubejs:market/export/food/7')
		...
		event.get('kubejs:market/export/food/8')
			.add(FD('beef_stew'))
			.add(FD('fried_rice'))
		event.get('kubejs:market/export/food/9')
			.add(FD('chicken_soup'))
			.add(FD('mixed_salad'))
			...
			.add(FD('ratatouille'))
		event.get('kubejs:market/export/food/10')
			.add(FD('vegetable_noodles'))
			.add(FD('pasta_with_meatballs'))
			.add(FD('mutton_wrap'))
			.add(MC('rabbit_stew'))
			.add(FD('pasta_with_mutton_chop'))
		event.get('kubejs:market/export/food/11')
			.add(FD('hamburger'))
			.add(FD('squid_ink_pasta'))
			.add(FD('pumpkin_soup'))
		event.get('kubejs:market/export/cooking')
			.add('#kubejs:market/export/food/3')
			.add('#kubejs:market/export/food/4')
			.add('#kubejs:market/export/food/5')
			.add('#kubejs:market/export/food/6')
			.add('#kubejs:market/export/food/7')
			.add('#kubejs:market/export/food/8')
			.add('#kubejs:market/export/food/9')
			.add('#kubejs:market/export/food/10')
			.add('#kubejs:market/export/food/11')
			.add('#kubejs:cookies')
		...
		event.get('kubejs:market/export/fish/1')
			.add(MC('cod'))
			.add(MC('salmon'))
			.add(MC('tropical_fish'))
			.add(MC('pufferfish'))
		event.get('kubejs:market/export/fish/3')
			...
			.add(AC('minnow'))
			.add(AC('blackfish'))
		event.get('kubejs:market/export/fish/5')
			.add(AC('pink_salmon'))
			.add(AC('brown_trout'))
			.add(AC('carp'))
			.add(AC('pollock'))
		...
		event.get('kubejs:market/export/fish/7')
			.add(AC('gar'))
			...
			.add(AC('red_grouper'))
			.add(AC('atlantic_cod'))
		event.get('kubejs:market/export/fish/8')
			.add(AC('muskellunge'))
			.add(AC('pacific_halibut'))
			.add(AC('atlantic_halibut'))
		event.get('kubejs:market/export/fish/10')
			.add(AC('catfish'))
			.add(AC('capitaine'))
			.add(AC('tuna'))
			.add(AC('arapaima'))
			.add(AC('#turtle'))
			.add(AC('goldfish'))
		event.get('kubejs:market/export/fishing')
			.add('#kubejs:market/export/fish/1')
			.add('#kubejs:market/export/fish/3')
			.add('#kubejs:market/export/fish/5')
			.add('#kubejs:market/export/fish/7')
			.add('#kubejs:market/export/fish/8')
			.add('#kubejs:market/export/fish/10')
			.add('kubejs:profession_card_fishing')

		event.get('kubejs:market/export/smithing')
			.add(MC('iron_sword'))
			.add(MC('iron_helmet'))
		...
		event.get('kubejs:market/export')
			.add('#kubejs:market/export/farming')
			.add('#kubejs:market/export/carpentry')
			.add('#kubejs:market/export/mining')
			.add('#kubejs:market/export/masonry')
			.add('#kubejs:market/export/hunting')
			.add('#kubejs:market/export/cooking')
			.add('#kubejs:market/export/fishing')
			.add('#kubejs:market/export/smithing')
