...
onEvent('item.registry', event => {
	...
	event.create('incomplete_coke_chunk').texture("kubejs:item/incomplete_coke_chunk",'create:sequenced_assembly').displayName('Cut Coke')
	...
	event.create('invar_compound').texture("kubejs:item/invar_compound",'create:sequenced_assembly').displayName('Unprocessed Invar Ingot')
